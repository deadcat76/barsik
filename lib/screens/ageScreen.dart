                ...
                child: Center(
                  child: Row(
                    ...
                    ElevatedButton(
                      ...
                      child: Text('До 5 лет', style: TextStyle(fontSize: 32, fontFamily: 'Rahovets', color: HexColor("#3E3A39")),),),
                    ElevatedButton(
                      onPressed: (){
                        GoRouter.of(context)
                            .pushNamed(MyAppRoutesConstants.actionRoute);
                      },
                      child: Text('От 5 до 8 лет', style: TextStyle(fontSize: 32, fontFamily: 'Rahovets', color: HexColor("#3E3A39")),),),
                      const SizedBox(
                        height: 165,
                      ),
                    ],
                        ...
                        children: [
                          Padding(padding: const EdgeInsets.only(top: 0, left: 0, bottom: 0, right: 20),
                              child: Expanded(child: Container(
                                  ...
                                  child: Text('Костя, приятно познакомиться! Скажи, пожалуйста, сколько тебе лет?',
